...
namespace Week6.EF
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            EagerLoadingKnightsWithWeapons();

            EagerLoadingKnightsWithWeapons_Filter();
        }
        ...
        private static void EagerLoadingKnightsWithWeapons()
        {
            //var knights = _knightsContext.Knights.ToList(); //NON si porta dietro le armi
        ...
        private static void EagerLoadingKnightsWithWeapons_Filter() //NON FUNZIONA
        {
            var knightsWithAscia = _knightsContext.Knights
                .Include(k => k.Weapons
                .Where(w => w.Description == "Ascia"))
                .ToList();

            //oppure Si potrebbe partire dalle armi, include dei cavalieri
        }
        //TODO: Sistemare
